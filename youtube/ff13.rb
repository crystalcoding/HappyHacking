...
url_1 = 'http://gdata.youtube.com/feeds/api/videos?author=HassanAlHajry&q=finalfantasyXIII&max-results=50&orderby=published'
url_2 = 'http://gdata.youtube.com/feeds/api/videos?author=HassanAlHajry&q=finalfantasyXIII&max-results=50&orderby=published&start-index=51'
url_3 = 'http://gdata.youtube.com/feeds/api/videos?author=HassanAlHajry&q=finalfantasyXIII&max-results=50&orderby=published&start-index=101'
