...
**
** Created: Mon Jun 22 21:09:12 2009
...
public:
    ...
    void setupUi(QDialog *Mama)
    {
        ...
        internetPushButton->setIconSize(QSize(60, 60));
    ...
    void retranslateUi(QDialog *Mama)
    {
        ...
        Mama->setStyleSheet(QApplication::translate("Mama", "QPushButton:hover:!pressed { background: pink; }", 0, QApplication::UnicodeUTF8));
